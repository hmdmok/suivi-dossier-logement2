                        ...
                        <div   hidden={this.state.hide_dossier} >
                            ...
                            <div className="col-sm order-sm-last" >
                                ...
                                <input 
                                    ...
                                    value="garage"  
                                    onChange={this.onHandleChange}  />
                                <label className="form-control text-right" htmlFor="garage">محل غير مخصص للسكن </label><br />
                                ...
                                <input 
                                    ...
                                    value="legem_1" 
                                    onChange={this.onHandleChange}  />
                                <label  className="form-control text-right"  htmlFor="legem_1">سكن خطر مهدد بالانهيار ملك جماعي</label><br />
                                ...
                                <input 
                                    ...
                                    value="legem_2" 
                                    onChange={this.onHandleChange}  />
                                <label className="form-control text-right" htmlFor="legem_2">سكن خطر مهدد بالانهيار ملك فردي</label><br />
                                ...
                                <input 
                                    ...
                                    value="legem_3" 
                                    onChange={this.onHandleChange}  />
                                <label className="form-control text-right"  htmlFor="legem_3">سكن عند الأقارب او مستأجر</label><br />
                                ...
                                <input 
                                    ...
                                    value="leg_f" 
                                    onChange={this.onHandleChange}  />
                                <label className="form-control text-right"  htmlFor="leg_f">سكن وظيفي</label><br />
                            ...
                            <div className="col-sm order-sm-first"> 
                                ...
                                <input 
                                    ...
                                    onChange={this.onHandleChange}
                                />
                                <label className="form-control text-right"   htmlFor="stuation_s_neant"> لاشيء </label><br />
                                ...
                                <input 
                                    ...
                                    onChange={this.onHandleChange}/>
                                <label className="form-control text-right"   htmlFor="stuation_s_avec_d"> ذوي حقوق</label><br />
                                ...
                                <input 
                                    ...
                                    onChange={this.onHandleChange}/>
                                <label className="form-control text-right"  htmlFor="stuation_s_andicap"> معاق</label><br /><br />
                               
                                <label >هل يوجد أشخاص متكفل بهم</label><br />
                                <select className="form-control text-right" onChange={this.onHandleChange} id="hide_tutele" defaultValue="non" name="hide_tutele">
                                    <option name="hide_tutele" value="non" >لا</option>
                                    <option name="hide_tutele" value="oui">نعم</option>
                                </select><br />
                                <div hidden={this.state.hide_tutele}>
                                    <label htmlFor="numb_p_t">عدد الأشخاص المتكفل بهم</label><br />
                                    <input className="form-control text-right" onChange={this.onHandleChange} type="text" name="numb_p" /><br />
                                </div>
                            ...
                            <div className= "row text-right">
                                <div className="col-sm order-sm-last my-2">   
                                    <input className="btn btn-lg btn-primary btn-block" type="submit" value="حفظ" /> 
                                </div>
                                <div className="col-sm order-sm-first my-2">
                                    <input className="btn btn-lg btn-primary btn-block" type="reset" value="إلغاء" />
                                </div>
                            </div>    
                        </div>    
